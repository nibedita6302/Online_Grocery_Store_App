        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body ">
                    <p>Please click Confirm if you want to DELETE Category</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" data-bs-dismiss="modal"
                    data-bs-toggle="modal" data-bs-target="#formModal1"                    
                    @click="selectApi_byRole('DELETE',this.store_delete_c)">
                        Confirm
                    </button>
        ...
        <div v-for="c in filteredCategory" class="col-4">
            <div class="card bg-dark text-white h-100">
                ...
                <div v-show="this.GET_USER_ROLE=='admin'" class="card-footer text-center">
                    ...
                    Update</button>
                    <button type="submit" class="btn btn-danger" @click="()=>{this.store_delete_c=c}"
